...
public class DashboardCinemaManager extends JFrame implements ActionListener {
    ...
    private JButton movieSessionButton;
    private JButton cinemaRoomsButton;
    ...
    public DashboardCinemaManager() {
        ...
        movieSessionButton = new JButton("Movie Session");
        movieSessionButton.addActionListener(this);
        cinemaRoomsButton = new JButton("Cinema Rooms");
        cinemaRoomsButton.addActionListener(this);
        ...
        constraints.gridy = 1;
        constraints.gridwidth = 2;
        panel.add(movieSessionButton, constraints);

        constraints.gridx = 0;
        constraints.gridy = 2;
        panel.add(cinemaRoomsButton, constraints);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == movieSessionButton) {
            // TODO: Handle movie session button action
        } else if (e.getSource() == cinemaRoomsButton) {
            // TODO: Handle cinema rooms button action
